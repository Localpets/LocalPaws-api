...
const socket = io('http://localhost:7000'); // Cambia la URL por la de tu servidor
...
export async function messageCreate(req, res) {
    ...
    try {
        const message = await Message.createMessage(sender_id, receiver_id, text);

        // Emitir el evento 'newMessage' a través de Socket.IO
...
export async function messageUpdate(req, res) {
    ...
    try {
        ...
        // Emitir el evento 'messageUpdated' a través de Socket.IO
...
export async function messageDelete(req, res) {
    ...
    try {
        ...
        // Emitir el evento 'messageDeleted' a través de Socket.IO
...
export async function messageAddReaction(req, res) {
    ...
    try {
        ...
        // Emitir el evento 'reactionAdded' a través de Socket.IO
...
export async function messageRemoveReaction(req, res) {
    ...
    try {
        ...
        // Emitir el evento 'reactionRemoved' a través de Socket.IO
        socket.emit('reactionRemoved', { messageId: message_id });
